...
function. For instance, given $k=3$ then it is true for $G, H \in \B^2
    \rightarrow \B$ that:
...
In practice, the rule calculates the truth tables that represent the cofactors
of $F$ and determines if either represents a constant function or if they are
