...
combinational logic that will be rewritten. We can use Backus-Naur form (BNF)
...
Now that the compiler can reason about Boolean logic, it needs to know how to
cover the logic with standard cells. We can do this in an ad-hoc fashion by
just declaring more rewrite rules that match to syntactical elements in the
logic.
