...
represents the structure of the input language, not the digial circuit itself.
...
from Fig.~\ref{fig:cost} and it is coverted back to Verilog. This enables
...
was performed. However, I can report the examples of compiling one example: a
2-bit carry lookahead unit.
